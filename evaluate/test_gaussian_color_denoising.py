...
parser.add_argument('--input_dir', default='datasets/test/ColorDN/', type=str, help='Directory of validation images')
parser.add_argument('--result_dir', default='./results/xformer_color_dn_sigma15/', type=str, help='Directory for results')
...
if sigma == 15:
    weights = 'experiments/pretrained_models/xformer_color_dn_sigma15.pth'
elif sigma == 25:
    weights = 'experiments/pretrained_models/xformer_color_dn_sigma25.pth'
else:
    weights = 'experiments/pretrained_models/xformer_color_dn_sigma50.pth'
